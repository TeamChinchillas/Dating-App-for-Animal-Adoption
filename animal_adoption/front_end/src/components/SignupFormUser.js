...
export default class SignupFormUser extends Component{
    ...
    checkClick = (event) => {
        ...
        this.setState((event) => {
            var animalDisposition = event.disposition_types;
            return animalDisposition[name] = checked;
        })
    }
        ...
        return(
            <div>
                ...
                <form onSubmit = {this.submitForm}>
                    ...
                    <br/>
                    <input type="email" name="emailAddress" placeholder="Email Address" value={this.state.email} onChange={this.handleChange} />
                    <br/>
                    ...
                    <label>Select Animal Disposition:
                        <br/>
                        <input type="checkbox" name="goodWithAnimals"  onChange={this.handleChange} />Good with other animals<br/> 
                        <input type="checkbox" name="goodWithChildren" onChange={this.handleChange} />Good with other children<br/> 
                        <input type="checkbox" name="animalLeashed" onChange={this.handleChange} />Animal must be leashed at all times<br/> 
                        <br/>
                    </label>
